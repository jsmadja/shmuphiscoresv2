...
export const CreateScore = (): VueStory => ({
...
export const CreateTimerScore = (): VueStory => ({
  components: { AddScoreTemplate },
  template: `
      <add-score-template :game="game"
...
export const WithDefaultValues = (): VueStory => ({
  components: { AddScoreTemplate },
  template: `
      <add-score-template :game="game"
...
export const WithReferenceScore = (): VueStory => ({
  components: { AddScoreTemplate },
  template: `
      <add-score-template :game="game"
                          :score="score"
...
export const WithPreviousScore = (): VueStory => ({
  components: { AddScoreTemplate },
  template: `
      <add-score-template :game="game"
                          :previousScore="score"
